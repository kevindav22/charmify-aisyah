  ...
  return (
    <div className="flex items-center justify-between gap-3 border-b border-rose-200 bg-rose-100 p-3 md:p-4">
      <div className="flex items-center overflow-hidden rounded-2xl border border-rose-300 bg-white shadow-sm">
        ...
        <div className="flex items-center justify-center border-x border-rose-300 px-3 text-sm font-semibold text-slate-700 md:px-4">{Math.round(zoom * 100)}%</div>
      ...
      <div className="flex items-center gap-2">
        <button onClick={onResetZoom} className="flex size-10 items-center justify-center rounded-xl border border-rose-300 bg-white text-slate-600 transition hover:border-rose-400 hover:text-rose-500 md:size-auto md:gap-2 md:px-4 md:py-2">
          <FiRotateCcw />
          <span className="hidden md:block">Reset</span>
        </button>

        <button onClick={onClear} className="flex size-10 items-center justify-center rounded-xl border border-red-200 bg-white text-red-500 transition hover:bg-slate-50 md:size-auto md:gap-2 md:px-4 md:py-2">
          <FiTrash2 />
