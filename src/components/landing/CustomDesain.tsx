      ...
      <div className="container mx-auto max-w-7xl px-5 py-12 md:px-8 lg:px-12">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <h2 className="mb-5 text-2xl font-black text-slate-900 md:text-3xl lg:text-4xl">
            Punya Ide Desain Charm Bracelet Versimu Sendiri!
          </h2>
          {/* DESCRIPTION */}
          <p className="mx-auto mb-10 max-w-2xl text-slate-600 md:text-lg">
            Kamu bisa membuat desain charm bracelet sendiri. Pilih, atur, dan ciptakan makna yang benar-benar personal.
          </p>

          {/* CTA BUTTON */}
          <Button  href="/customize" className="group">
